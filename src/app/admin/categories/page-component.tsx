...
const CategoriesPageComponent: FC<Props> = ({ categories }) => {
    ...
    return <main className='grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8'>CategoriesPageComponent
        <div className='flex items-center my-10'>
            <div className='ml-auto flex items-center gap-2'>
                <Dialog open={
                    isCreateCategoryModalOpen} onOpenChange={() => setIsCreateCategoryModalOpen(!isCreateCategoryModalOpen)}>
                    <DialogTrigger asChild>
                        <Button size="sm" className='h-8 gap-1' onClick={() => { setCurrentCategory(null); setIsCreateCategoryModalOpen(true) }}>
                            <PlusCircle className='h-3.5 w-3.5'></PlusCircle>
                            <span className='sr-only sm:not-sr-only sm:whitespace'>Add category</span>
                        </Button>
                    </DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                        ...
                        <CategoryForm form={form} onSubmit={submitCategoryHandler} defaultValues={currentCategory}></CategoryForm>
                    </DialogContent>
                </Dialog>
            </div>
        </div>
                ...
                <Table className='min-w-[600px]'>
                    ...
                    <TableBody>{
                        categories.map(category => <CategoryTableRow key={category.id} category={category} setCurrentCategory={setCurrentCategory}
                            setIsCreateCategoryModalOpen={setIsCreateCategoryModalOpen} deleteCategoryHandler={deleteCategoryHandler}></CategoryTableRow>)}</TableBody>
                </Table>
            </CardContent>
        </Card>
    </main>
